...
<div id="kanan">
	...
	<div id="slides">
		...
		<?php 
			...
			$queryBanner = mysqli_query($koneksi, "SELECT * FROM banner WHERE status='on' ORDER BY banner_id DESC LIMIT 5");
	...
	<div id="frame-barang">
		...
		<ul>
			<?php 
				...
				$query = mysqli_query($koneksi, "SELECT barang.*, kategori.kategori FROM barang JOIN kategori ON barang.kategori_id=kategori.kategori_id WHERE barang.status='on' $kategori_id ORDER BY rand() DESC LIMIT 12");
