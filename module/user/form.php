...
<form action="<?php echo BASE_URL."module/user/action.php?user_id=$user_id"?>" method="POST">
	...
	<div class="element-form">
		...
		<span><input type="text" name="nama" value="<?php echo $nama; ?>" readonly="true" /></span>
	</div>	

	<div class="element-form">
		<label>Email</label>	
		<span><input type="text" name="email" value="<?php echo $email; ?>" readonly="true" /></span>
	</div>		

	<div class="element-form">
		<label>Phone</label>	
		<span><input type="text" name="phone" value="<?php echo $phone; ?>" readonly="true" /></span>
	</div>	

	<div class="element-form">
		<label>Alamat</label>	
		<span><input type="text" name="alamat" value="<?php echo $alamat; ?>" readonly="true" /></span>
	</div>		
